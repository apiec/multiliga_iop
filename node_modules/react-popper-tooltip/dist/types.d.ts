...
export declare type TriggerType = 'click' | 'right-click' | 'hover' | 'focus';
...
export declare type PopperOptions = Partial<PopperJS.Options> & {
    createPopper?: typeof PopperJS.createPopper;
};
export declare type PropsGetterArgs = {
